...
const mobileViewMap = {
  'dashboard/wechatBoard/index': 'dashboard/mobileBoard/index',
  'media/mediaProduct/index': 'media/mobileMediaProduct/index',
  'article/articleList/index': 'article/mobileArticleList/index',
...
export const loadView = (view) => {
  let targetView = view
  if (isMobile() && mobileViewMap[view]) {
    targetView = mobileViewMap[view]
  }
  let res
