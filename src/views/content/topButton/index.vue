            ...
            <el-form :model="button" label-width="120px" :ref="(el) => (formRefs[index] = el)">
              ...
              >
                <el-radio-group v-model="button.buttonType">
                  ...
                  <el-radio label="3">下拉按钮</el-radio>
                </el-radio-group>
              </el-form-item>
              ...
              <template v-if="button.buttonType === '3'">
                <div class="dropdown-options-container">
                  <div class="dropdown-header">
                    <h5>下拉选项配置</h5>
                    <el-button type="primary" size="small" @click="addDropdownOption(button)">
                      <el-icon>
                        <Plus />
                      </el-icon>
                      添加选项
