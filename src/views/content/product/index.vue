  ...
  <div class="product-container">
    <div class="title-container">
      ...
      <div class="action-buttons">
        ...
        <el-button v-if="publishStatus !== '1'" type="success" @click="handlePublish"
          >发布</el-button
        >
    ...
    <template v-if="auth.hasPermi('product:industry:set') || auth.hasPermi('product:device:set')">
        ...
        <el-card shadow="hover" class="company-card">
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item
                ...
                :rules="[
                  ...
                  { max: 20, message: '产品名称最多20个字符', trigger: 'blur' },
                ]"
              >
                <el-input
                  v-model="currentProductBasicInfo.productName"
                  placeholder="请输入产品名称"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="产品简介" prop="productIntro">
                <el-input
                  v-model="currentProductBasicInfo.productIntro"
                  placeholder="请输入产品简介"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item
                ...
                :rules="[
                  { required: true, message: '请选择背景图片', trigger: ['blur', 'change'] },
                ]"
              >
                <div class="logo-upload-wrapper">
                  <el-input
                    v-model="currentProductBasicInfo.backgroundImage"
                    type="textarea"
                    placeholder="请选择背景图片"
                    readonly
                  ...
                  <el-upload
                    ...
                    :http-request="(params) => handleBasicImageUpload(params)"
                    :before-upload="handleBeforeUpload"
                    :file-list="currentProductBasicInfo.backgroundImageFileList"
                    :limit="1"
                    :on-exceed="handleExceed"
                    :on-remove="(file, fileList) => handleBasicImageRemove(file, fileList)"
                    list-type="text"
                  >
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              ...
              >
                <el-input
                  v-model="currentProductBasicInfo.detailedIntroduction"
                  placeholder="请详细描述产品内容"
                  type="textarea"
                  :rows="5"
                ></el-input>
              </el-form-item>
      ...
      <el-form :model="currentApplicationScenariosTemp" label-width="120px">
        <el-card shadow="hover" class="company-card">
          ...
          <div class="certification-settings">
            <div
              v-for="(scenario, index) in currentApplicationScenariosTemp"
              :key="index"
            ...
            >
              <el-form
                :model="scenario"
                label-width="120px"
                :ref="(el) => (scenarioFormRefs[index] = el)"
              >
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item
                      ...
                      prop="scenarioName"
                      :rules="[
                        { required: true, message: '请输入应用场景名称', trigger: 'blur' },
                        { max: 20, message: '应用场景名称最多20个字符', trigger: 'blur' },
                      ]"
                    >
                      <el-input
                  ...
                  <el-col :span="12">
                    <el-form-item label="应用场景简介" prop="scenarioIntro">
                      <el-input
                        v-model="scenario.scenarioIntro"
                        placeholder="请输入应用场景简介"
                        show-word-limit
                        maxlength="60"
                      ></el-input>
                    </el-form-item>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="场景缩略图地址" prop="iconUrl">
                      <div class="logo-upload-wrapper">
                        <el-input
                          v-model="scenario.iconUrl"
                          type="textarea"
                          placeholder="请选择产品缩略图"
                          readonly
                          class="image-url-input"
                        />
                        <el-upload
                          class="image-upload-btn"
                          :http-request="
                            (params) => handleScenarioThumbnailUpload(params, scenario)
                          "
                          :before-upload="handleBeforeUpload"
                          :file-list="scenario.thumbnailImageFileList"
                          :limit="1"
                          :on-exceed="handleExceed"
                          :on-remove="
                            (file, fileList) =>
                              handleScenarioThumbnailRemove(file, fileList, scenario)
                          "
                          list-type="text"
                        >
                          <el-button type="primary">选择图片</el-button>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    ...
                    >
                      <div class="logo-upload-wrapper">
                        <el-input
                          v-model="scenario.backgroundImageUrl"
                          type="textarea"
                          placeholder="请选择背景图片"
                          readonly
                          class="image-url-input"
                        ...
                        <el-upload
                          class="image-upload-btn"
                          :http-request="
                            (params) => handleScenarioBackgroundUpload(params, scenario)
                          "
                          :before-upload="handleBeforeUpload"
                          :file-list="scenario.backgroundImageFileList"
                          :limit="1"
                          :on-exceed="handleExceed"
                          :on-remove="
                            (file, fileList) =>
                              handleScenarioBackgroundRemove(file, fileList, scenario)
                          "
                          list-type="text"
                        >
                          <el-button type="primary">选择图片</el-button>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="详细介绍" prop="detailedIntroduction">
                      <el-input
                        v-model="scenario.detailedIntroduction"
                        placeholder="请详细描述产品内容"
                        type="textarea"
                        :rows="5"
                        show-word-limit
            ...
            <div class="add-certification-container">
              <el-button
                ...
                size="small"
                @click="addScenario"
                :disabled="currentApplicationScenariosTemp.length >= 5"
              >
                <el-icon>
                  <Plus />
                </el-icon>
      ...
      <el-form :model="currentTypicalCasesTemp" label-width="120px">
        <el-card shadow="hover" class="company-card">
          ...
          <div class="certification-settings">
            <div
              v-for="(caseItem, index) in currentTypicalCasesTemp"
              :key="index"
              class="certification-item"
            >
              <el-form
              ...
              >
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item
                      ...
                      prop="caseName"
                      :rules="[
                        { required: true, message: '请输入案例/产品名称', trigger: 'blur' },
                        { max: 20, message: '案例/产品名称最多20个字符', trigger: 'blur' },
                      ]"
                    >
                      <el-input
                        v-model="caseItem.caseName"
                        placeholder="请输入案例/产品名称"
                        show-word-limit
                        maxlength="20"
                      ></el-input>
                    </el-form-item>
                  ...
                  <el-col :span="12">
                    <el-form-item label="案例/产品简介" prop="caseIntro">
                      <el-input
                        v-model="caseItem.caseIntro"
                        placeholder="请输入案例/产品简介"
                        show-word-limit
                        maxlength="60"
                      ></el-input>
                    </el-form-item>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="标配功能" prop="titleFeatures">
                      <el-input
                        v-model="caseItem.titleFeatures"
                        placeholder="请输入标配功能，多个用'，'隔开"
                        show-word-limit
                        maxlength="200"
                      ></el-input>
                    </el-form-item>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="定制服务" prop="customServices">
                      <el-input
                        v-model="caseItem.customServices"
                        placeholder="请输入定制服务，多个用'，'隔开"
                        show-word-limit
                        maxlength="200"
                      ></el-input>
                    </el-form-item>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    ...
                    >
                      <div class="logo-upload-wrapper">
                        <el-input
                          v-model="caseItem.caseImageUrl"
                          type="textarea"
                          placeholder="请选择案例/产品图片"
                          readonly
                          class="image-url-input"
                        />
                        <el-upload
                          ...
                          :before-upload="handleBeforeUpload"
                          :file-list="caseItem.caseImageFileList"
                          :limit="1"
                          :on-exceed="handleExceed"
                          :on-remove="
                            (file, fileList) => handleCaseImageRemove(file, fileList, caseItem)
                          "
                          list-type="text"
                        >
                          <el-button type="primary">选择图片</el-button>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="详细介绍" prop="detailedIntroduction">
                      <el-input
                        v-model="caseItem.detailedIntroduction"
                        placeholder="请详细描述案例/产品内容"
                        type="textarea"
                        :rows="5"
                        show-word-limit
                        maxlength="500"
            ...
            <div class="add-certification-container">
              <el-button
                ...
                size="small"
                @click="addCase"
                :disabled="currentTypicalCasesTemp.length >= 5"
              >
                <el-icon>
                  <Plus />
                </el-icon>
...
const currentApplicationScenariosTemp = computed({
  get() {
    return activeTab.value === 'model'
      ? modelData.value.applicationScenariosTemp
      : deviceData.value.applicationScenariosTemp;
  },
  set(value) {
    if (activeTab.value === 'model') {
...
const currentTypicalCasesTemp = computed({
  get() {
    return activeTab.value === 'model'
      ? modelData.value.typicalCasesTemp
      : deviceData.value.typicalCasesTemp;
  },
  set(value) {
    if (activeTab.value === 'model') {
  ...
  getProduct()
    .then((res) => {
      if (res.code === 200) {
        ...
        const llmBasicInfo = useTempFields
          ? res.data.txwxLLMProductBasicInfoTemp
          : res.data.txwxLLMProductBasicInfo;
        if (llmBasicInfo) {
          modelData.value.productBasicInfo = {
            ...
            backgroundImageFileList: llmBasicInfo.backgroundImageUrl
              ? [
                  {
                    name: llmBasicInfo.backgroundImageUrl.split('/').pop() || '背景图',
                    url: llmBasicInfo.backgroundImageUrl,
                  },
                ]
              : [],
        ...
        const llmApplicationScenarios = useTempFields
          ? res.data.txwxLLMApplicationScenariosTemp
          : res.data.txwxLLMApplicationScenarios;
        modelData.value.applicationScenariosTemp = llmApplicationScenarios?.map((scenario) => ({
          ...
          thumbnailImageFileList: scenario.iconUrl
            ? [{ name: scenario.iconUrl.split('/').pop() || '缩略图', url: scenario.iconUrl }]
            : [],
          backgroundImageUrl: scenario.backgroundImageUrl || '',
          backgroundImageFileList: scenario.backgroundImageUrl
            ? [
                {
                  name: scenario.backgroundImageUrl.split('/').pop() || '背景图',
                  url: scenario.backgroundImageUrl,
                },
              ]
            : [],
        ...
        const llmTypicalCases = useTempFields
          ? res.data.txwxLLMTypicalCaseProductsTemp
          : res.data.txwxLLMTypicalCaseProducts;
        modelData.value.typicalCasesTemp = llmTypicalCases?.map((caseItem) => ({
          ...
          caseImageFileList: caseItem.imageUrl
            ? [{ name: caseItem.imageUrl.split('/').pop() || '案例图', url: caseItem.imageUrl }]
            : [],
        ...
        // 处理小装置数据
        const deviceBasicInfo = useTempFields
          ? res.data.txwxDeviceProductBasicInfoTemp
          : res.data.txwxDeviceProductBasicInfo;
        if (deviceBasicInfo) {
          deviceData.value.productBasicInfo = {
            ...
            backgroundImageFileList: deviceBasicInfo.backgroundImageUrl
              ? [
                  {
                    name: deviceBasicInfo.backgroundImageUrl.split('/').pop() || '背景图',
                    url: deviceBasicInfo.backgroundImageUrl,
                  },
                ]
              : [],
        ...
        const deviceApplicationScenarios = useTempFields
          ? res.data.txwxDeviceApplicationScenariosTemp
          : res.data.txwxDeviceApplicationScenarios;
        ...
        const deviceTypicalCases = useTempFields
          ? res.data.txwxDeviceTypicalCaseProductsTemp
          : res.data.txwxDeviceTypicalCaseProducts;
